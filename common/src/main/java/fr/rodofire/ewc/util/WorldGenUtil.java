...
public class WorldGenUtil {
    ...
    public static Direction getRandomDirection(RandomSource random) {
        return switch (random.nextIntBetweenInclusive(0, 5)) {
            case 0 -> Direction.WEST;
            case 1 -> Direction.EAST;
            case 2 -> Direction.NORTH;
            case 3 -> Direction.SOUTH;
    ...
    public static Direction getRandomVerticalDirection(RandomSource random) {
        return random.nextIntBetweenInclusive(0, 1) == 1 ? Direction.UP : Direction.DOWN;
    }
    ...
    public static int getSecondHeight(float chance, int minHeight, int maxHeight) {
        if (RandomSource.create().nextFloat() < chance) {
            return RandomSource.create().nextIntBetweenInclusive(minHeight, maxHeight);
        }
        return 0;
    }
    ...
    public static double getAbs(Vec3 pos) {
        return MathUtil.absDistance(pos.x, pos.y, pos.z);
    }

    public static double getSquared(Vec3 pos) {
    ...
    public static float getDistance(Vec3 pos1, Vec3 pos2) {
        return FastMaths.getLength((float) (pos1.x() - pos2.x()), (float) (pos1.y() - pos2.y()), (float) (pos1.z() - pos2.z()));
    }

    public static float getDistance(Vec3 pos1, Vec3 pos2, float precision) {
        return FastMaths.getLengthWPrecision((float) (pos1.x() - pos2.x()), (float) (pos1.y() - pos2.y()), (float) (pos1.z() - pos2.z()), precision);
    }
    ...
    public static double getDistanceFromPointToPlane(Vec3 normal, Vec3 pointOnPlane, Vec3 point) {
        double A = normal.x;
        double B = normal.y;
        double C = normal.z;
    ...
    public static float getDistanceToAxis(Vec3 centerPos, Vec3 axisDir, Vec3 pos) {
        Vec3 v = pos.subtract(centerPos);
        Vec3 cross = v.cross(axisDir);
    ...
    public static double getExactDistance(Vec3 pos) {
