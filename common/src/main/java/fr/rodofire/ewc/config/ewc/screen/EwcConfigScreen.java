...
public class EwcConfigScreen extends DefaultConfigScreen {
    ...
    public EwcConfigScreen(Screen parent) {
        super(parent, EwcClientConfig.CLIENT_CONFIG, EwcConstants.MOD_ID, ResourceLocation.fromNamespaceAndPath(EwcConstants.MOD_ID, "textures/gui/config_background.png"), 1920, 1080, 0xAFAFAFFF, 0xD8000000);
    }
    ...
    public ImageButtonWidget createButton(String link, int yOffset, ResourceLocation icon) {
        ...
        return new ImageButtonWidget(
                8, this.height / 2 + (int) (yOffset * (getIconSize == 24 ? 1 : 0.75)),
    ...
    public int getIconSize() {
        int large = Minecraft.getInstance().getWindow().getScreenHeight();
